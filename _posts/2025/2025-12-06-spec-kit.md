...
| Tool               | Purpose                             |
+--------------------+-------------------------------------+
| Python 3.11+       | Running SpecKit CLI                 |
| UV                 | Python Package Manager              |
| GitHub CLI         | Repository management               |
| Visual Studio Code | Running prompts for implementation  |
| Cursor             | Running prompts for implementation  |
| Claude Code        | Running prompts for planning        |
| SpecKit Companion  | Running SpecKit in VS Code          |
